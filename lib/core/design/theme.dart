...
abstract final class AppTheme {
  ...
  static ThemeData _build(Brightness brightness) {
    ...
    final colorScheme = ColorScheme(
      ...
      primaryContainer: isLight ? AppColors.primaryContainerLight : AppColors.primaryContainerDark,
      onPrimaryContainer: isLight ? AppColors.onPrimaryContainerLight : AppColors.onPrimaryContainerDark,
      secondary: isLight ? AppColors.secondaryLight : AppColors.secondaryDark,
      onSecondary: isLight ? AppColors.onSecondaryLight : AppColors.onSecondaryDark,
      secondaryContainer: isLight ? AppColors.secondaryContainerLight : AppColors.secondaryContainerDark,
      onSecondaryContainer: isLight ? AppColors.onPrimaryContainerLight : AppColors.onPrimaryContainerDark,
      ...
      onSurfaceVariant: isLight ? AppColors.onSurfaceVariantLight : AppColors.onSurfaceVariantDark,
      error: isLight ? AppColors.errorLight : AppColors.errorDark,
      onError: Colors.white,
      outline: isLight ? AppColors.outlineLight : AppColors.outlineDark,
      outlineVariant: isLight ? AppColors.outlineVariantLight : AppColors.outlineVariantDark,
      surfaceContainerHighest: isLight ? AppColors.primaryContainerLight : AppColors.surfaceDark,
    );
    ...
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: colorScheme.outline.withValues(alpha: isLight ? 0.5 : 0.15)),
        ),
      ),

      navigationBarTheme: NavigationBarThemeData(
        backgroundColor: isLight ? AppColors.surfaceLight : AppColors.surfaceDark,
        indicatorColor: colorScheme.primary.withValues(alpha: isLight ? 0.15 : 0.2),
